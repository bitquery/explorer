export default function renderDexProtocolLink(data,variables,chainId) {
	...
	// link.href = `https://explorer.bitquery.io/${WidgetConfig.getNetwork(chainId)}/dex_protocol/${data.ProtocolName}`;
	link.href = `/${WidgetConfig.getNetwork(chainId)}/dex_protocol/${data.ProtocolName}`;
