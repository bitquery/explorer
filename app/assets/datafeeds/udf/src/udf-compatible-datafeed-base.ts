import {
  ...
  VisiblePlotsSet,
} from '../../../javascript/charting_library/datafeed-api';

import {getErrorMessage, logMessage, RequestParams, UdfErrorResponse} from './helpers';

import {GetBarsResult, HistoryProvider, LimitedResponseConfiguration, PeriodParamsWithOptionalCountback} from './history-provider';
...
export class UDFCompatibleDatafeedBase implements IExternalDatafeed, IDatafeedQuotesApi, IDatafeedChartApi {
  ...
  protected constructor(datafeedURL: string, quotesProvider: IQuotesProvider, requester: Requester, updateFrequency: number = 10 * 1000, limitedServerResponse?: LimitedResponseConfiguration) {
...
function defaultConfiguration(): UdfCompatibleConfiguration {
  return {
    ...
    supported_resolutions: ['1' as ResolutionString, '5' as ResolutionString, '15' as ResolutionString, '30' as ResolutionString, '60' as ResolutionString, '1D' as ResolutionString, '1W' as ResolutionString, '1M' as ResolutionString],
