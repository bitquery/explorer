Rails.application.routes.draw do
  ...
  scope '(:locale)', constraints: lambda { |request|
    ...
    BLOCKCHAINS.select { |b| b[:family] == 'ethereum' }.each do |blockchain|
      ...
      get ':blockchain/address/:address/graph', controller: "#{blockchain[:family]}/address", action: 'money_flow',
                                                constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      ...
      get ':blockchain/address/:address', controller: "#{blockchain[:family]}/address", action: 'show',
                                          constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      get ':blockchain/address/:address/nft_address', controller: "#{blockchain[:family]}/address", action: 'show',
                                                      constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }

      get ':blockchain/smart_contract/:address/graph', controller: "#{blockchain[:family]}/smart_contract",
                                                       action: 'money_flow', constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      get ':blockchain/smart_contract/:address/:action', controller: "#{blockchain[:family]}/smart_contract",
                                                         constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      get ':blockchain/smart_contract/:address', controller: "#{blockchain[:family]}/smart_contract", action: 'show',
                                                 constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }

      get ':blockchain/token/:address/graph', controller: "#{blockchain[:family]}/token", action: 'money_flow',
                                              constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      ...
      get ':blockchain/token/:address/id/:id', controller: "#{blockchain[:family]}/token", action: 'show_nft_id',
                                               constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      get ':blockchain/token/:smart_contract/nft_smart_contract', controller: "#{blockchain[:family]}/token",
                                                                  action: 'show', constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      get ':blockchain/token/:smart_contract/trading', controller: "#{blockchain[:family]}/token", action: 'show',
                                                       constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      ...
      get ':blockchain/dex_protocol/:protocol_name/:action', controller: "#{blockchain[:family]}/dex_protocol",
                                                             constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      get ':blockchain/dex_protocol/:protocol_name', controller: "#{blockchain[:family]}/dex_protocol",
                                                     action: 'statistics', constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }

      get ':blockchain/dex/:exchange/:action', controller: "#{blockchain[:family]}/dex",
                                               constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      get ':blockchain/dex/:exchange', controller: "#{blockchain[:family]}/dex", action: 'statistics',
                                       constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }

      get ':blockchain/sitemap/index.xml', controller: "#{blockchain[:family]}/sitemap", action: 'index',
                                           constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      get ':blockchain/tokenpair/:token1/:token2/', controller: "#{blockchain[:family]}/token_pair", action: 'show',
                                                    constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      get ':blockchain/tokenpair/:token1/:token2/:action', controller: "#{blockchain[:family]}/token_pair",
                                                           constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
    end
    ...
    BLOCKCHAINS.select { |b| b[:family] == 'ethereum2' }.each do |blockchain|
      ...
      get ':blockchain/validator/:index/:action', controller: "#{blockchain[:family]}/validator",
                                                  constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      get ':blockchain/validator/:index', controller: "#{blockchain[:family]}/validator", action: 'show',
                                          constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }

      get ':blockchain/block/:block', controller: "#{blockchain[:family]}/block", action: 'show',
                                      constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      get ':blockchain/block/:block/:action', controller: "#{blockchain[:family]}/block", action: 'show',
                                              constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
    end
    BLOCKCHAINS.select { |b| b[:family] == 'ethereum_streaming' }.each do |blockchain|
      ...
      get ':blockchain/dex_protocol/:protocol_name/', controller: "#{blockchain[:family]}/dex_protocol",
                                                      action: 'statistics', constraints: { blockchain: blockchain[:network], protocol_name: %r{[^/]+} }, defaults: { network: blockchain }, format: false
      ...
      get ':blockchain/sitemap/index.xml', controller: "#{blockchain[:family]}/sitemap", action: 'index',
                                           constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      get ':blockchain/tokenpair/:token1/:token2', controller: "#{blockchain[:family]}/token_pair",
                                                   action: 'trading_view', constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      get ':blockchain/tokenpair/:token1/:token2/trading_view', controller: "#{blockchain[:family]}/token_pair",
                                                                action: 'trading_view', constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      get ':blockchain/tokenpair/:token1/:token2/last_trades', controller: "#{blockchain[:family]}/token_pair",
                                                               action: 'last_trades', constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
    end
    ...
    BLOCKCHAINS.select { |b| b[:family] == 'tron' }.each do |blockchain|
      ...
      get ':blockchain/trc20token/:address/:action', controller: "#{blockchain[:family]}/trc20token",
                                                     constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      get ':blockchain/trc20token/:address', controller: "#{blockchain[:family]}/trc20token", action: 'show',
                                             constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }

      get ':blockchain/trc10token/:address/:action', controller: "#{blockchain[:family]}/trc10token",
                                                     constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      get ':blockchain/trc10token/:address', controller: "#{blockchain[:family]}/trc10token", action: 'show',
                                             constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
    ...
    BLOCKCHAINS.select { |b| b[:family] == 'eos' }.each do |blockchain|
      ...
      get ':blockchain/address/:address/money_flow', controller: "#{blockchain[:family]}/address",
                                                     action: 'money_flow', constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      get ':blockchain/address/:address/:action', controller: "#{blockchain[:family]}/address",
      ...
      get ':blockchain/smart_contract/:address/money_flow', controller: "#{blockchain[:family]}/smart_contract",
                                                            action: 'money_flow', constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      get ':blockchain/smart_contract/:address/:action', controller: "#{blockchain[:family]}/smart_contract",
                                                         constraints: { blockchain: blockchain[:network], address: %r{[^/]+} }, defaults: { network: blockchain }
      get ':blockchain/smart_contract/:address', controller: "#{blockchain[:family]}/smart_contract", action: 'show',
      ...
      get ':blockchain/token/:address/money_flow', controller: "#{blockchain[:family]}/token", action: 'money_flow',
                                                   constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      get ':blockchain/token/:address/:action', controller: "#{blockchain[:family]}/token",
                                                constraints: { blockchain: blockchain[:network], address: %r{[^/]+} }, defaults: { network: blockchain }
      get ':blockchain/token/:address', controller: "#{blockchain[:family]}/token", action: 'show',
    ...
    BLOCKCHAINS.select { |b| b[:family] == 'hedera' }.each do |blockchain|
      constraints(blockchain: blockchain[:network]) do
        defaults network: blockchain do
          ...
          get ':blockchain/topics/:topic_id', controller: "#{blockchain[:family]}/topics", action: 'show',
                                              constraints: { topic_id: %r{[^/]+} }
          get ':blockchain/topics/:topic_id/:action', controller: "#{blockchain[:family]}/topics",
                                                      constraints: { topic_id: %r{[^/]+} }

          get ':blockchain/accounts/:account_id', controller: "#{blockchain[:family]}/accounts", action: 'show',
                                                  constraints: { account_id: %r{[^/]+} }
          get ':blockchain/accounts/:account_id/:action', controller: "#{blockchain[:family]}/accounts",
                                                          constraints: { account_id: %r{[^/]+} }

          get ':blockchain/nodes/:node_account', controller: "#{blockchain[:family]}/nodes", action: 'show',
                                                 constraints: { node_account: %r{[^/]+} }
          get ':blockchain/payers/:payer_account', controller: "#{blockchain[:family]}/payers", action: 'show',
                                                   constraints: { payer_account: %r{[^/]+} }

          get ':blockchain/contracts/:contract_id', controller: "#{blockchain[:family]}/contracts", action: 'show',
    ...
    BLOCKCHAINS.select { |b| b[:family] == 'binance' }.each do |blockchain|
      ...
      get ':blockchain/order/:order/:action', controller: "#{blockchain[:family]}/order",
                                              constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      get ':blockchain/order/:order', controller: "#{blockchain[:family]}/order", action: 'statuses',
                                      constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
    ...
    BLOCKCHAINS.select { |b| b[:family] == 'filecoin' }.each do |blockchain|
      ...
      get ':blockchain/message/:hash', controller: "#{blockchain[:family]}/message", action: 'show',
                                       constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      get ':blockchain/message/:hash/transfers', controller: "#{blockchain[:family]}/message", action: 'transfers',
                                                 constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      ...
      get ':blockchain/height/:height/:action', controller: "#{blockchain[:family]}/height",
                                                constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      get ':blockchain/height/:height', controller: "#{blockchain[:family]}/height", action: 'blocks',
                                        constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
    ...
    BLOCKCHAINS.select { |b| b[:family] == 'algorand' }.each do |blockchain|
      ...
      get ':blockchain/token/:id/:action', controller: "#{blockchain[:family]}/token",
                                           constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      get ':blockchain/token/:id', controller: "#{blockchain[:family]}/token", action: 'show',
                                   constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
    ...
    BLOCKCHAINS.select { |b| b[:family] == 'tezos' }.each do |blockchain|
      ...
      get ':blockchain/address/:address', controller: "#{blockchain[:family]}/address", action: 'show',
                                          constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
      get ':blockchain/address/:address/balances', controller: "#{blockchain[:family]}/address", action: 'balances',
                                                   constraints: { blockchain: blockchain[:network] }, defaults: { network: blockchain }
